...
<style>
 ...
 :root{--coral:#e95f3e;--olive:#6b8e23;--amber:#cf8b22;--bg:#faf9f5;--card:#ffffff;--border:#ece0d8;--ink:#37312c;--muted:#8c817a;}
 ...
 [data-testid="stMetric"]{background:#ffffff;border:1px solid #ece0d8;border-radius:14px;padding:.7rem 1rem;box-shadow:0 1px 3px rgba(55,49,44,.04);}
 .kpi-box{background:#ffffff;border:1px solid #ece0d8;border-radius:16px;padding:1rem 1.1rem;min-height:96px;box-shadow:0 1px 3px rgba(55,49,44,.05);}
 ...
 .section-header{font-family:'Golos Text',sans-serif;font-size:.78rem;text-transform:uppercase;letter-spacing:1.6px;
   color:#8c817a;border-bottom:1px solid #ece0d8;padding-bottom:6px;margin:1.6rem 0 1rem;font-weight:600;}
 .card{background:#ffffff;border:1px solid #ece0d8;border-left:3px solid #e95f3e;padding:.9rem 1.1rem;border-radius:14px;
   margin:.5rem 0;font-size:.9rem;color:#37312c;line-height:1.6;box-shadow:0 1px 3px rgba(55,49,44,.04);}
 ...
 .info-box{background:#ffffff;border:1px solid #ece0d8;border-radius:14px;padding:.9rem;margin:.6rem 0;font-size:.83rem;color:#8c817a;line-height:1.6;}
 .hero{font-family:'Golos Text',sans-serif;font-size:1.9rem;font-weight:700;color:#37312c;letter-spacing:-.5px;}
 .stTabs [data-baseweb="tab"]{font-family:'Golos Text',sans-serif;font-size:.9rem;color:#8c817a;font-weight:500;}
 .stTabs [aria-selected="true"]{color:#e95f3e !important;}
 .stTabs [data-baseweb="tab-highlight"]{background:#e95f3e;}
 div[data-testid="stSidebar"]{background:#f5efe9;border-right:1px solid #ece0d8;}
 .sidebar-section{font-size:.7rem;text-transform:uppercase;letter-spacing:1.4px;color:#a89d95;margin:1rem 0 .3rem;font-weight:600;}
